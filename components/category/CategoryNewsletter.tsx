...
export function CategoryNewsletter() {
  return (
          ...
          <div className="relative overflow-hidden bg-navy rounded-3xl px-8 py-14 md:px-16 md:py-16 text-center">
            ...
            <div className="relative max-w-lg mx-auto">
              <h2 className="text-2xl md:text-3xl font-semibold text-white">
                Never miss a Windows update.
              </h2>
              <p className="mt-3 text-white/65 leading-relaxed">
                Get new Windows guides and fixes delivered as they're
                published. No noise, unsubscribe anytime.
              </p>
