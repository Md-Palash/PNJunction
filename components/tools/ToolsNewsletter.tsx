...
export function ToolsNewsletter() {
  return (
          ...
          <div className="relative overflow-hidden bg-navy rounded-3xl px-8 py-14 md:px-16 md:py-16 text-center">
            ...
            <div className="relative max-w-lg mx-auto">
              ...
              <p className="mt-3 text-white/65 leading-relaxed">
                We'll let you know when a new tool ships. No noise,
                unsubscribe anytime.
              </p>
              ...
              >
                <label htmlFor="tools-newsletter-email" className="sr-only">
                  Email address
                </label>
                <input
                  id="tools-newsletter-email"
                  type="email"
                  required
